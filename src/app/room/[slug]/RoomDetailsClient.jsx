...
const amenitiesParChambre = {
    'chambre-twins': [
        { icon: '/assets/images/icon/bed-2.svg',          label: '2 Lits individuels et 2 chevets' },
        { icon: '/assets/images/icon/shower.svg',         label: 'Douche italienne' },
        { icon: '/assets/images/icon/desk.svg',           label: 'Table de travail' },
        { icon: '/assets/images/icon/hot-coffe.svg',      label: 'Plateau de courtoisie' },
        { icon: '/assets/images/icon/snow.svg',           label: 'Climatisation' },
        { icon: '/assets/images/icon/wifi.svg',           label: 'Wifi' },
        { icon: '/assets/images/icon/refrigerator.svg',   label: 'Mini bar' },
        { icon: '/assets/images/icon/security.svg',       label: 'Coffre-fort à la demande' },
        { icon: '/assets/images/icon/home-theater.svg',   label: 'Télévision écran plat' },
    ],
    'chambre-superieure': [
        { icon: '/assets/images/icon/bed.svg',            label: 'Lit double' },
        { icon: '/assets/images/icon/shower.svg',         label: 'Douche / Baignoire' },
        { icon: '/assets/images/icon/desk.svg',           label: 'Table de travail' },
        { icon: '/assets/images/icon/hot-coffe.svg',      label: 'Plateau de courtoisie' },
        { icon: '/assets/images/icon/snow.svg',           label: 'Climatisation' },
        { icon: '/assets/images/icon/wifi.svg',           label: 'Wifi' },
        { icon: '/assets/images/icon/balcony.svg',        label: 'Balcon ou non' },
        { icon: '/assets/images/icon/refrigerator.svg',   label: 'Mini bar' },
        { icon: '/assets/images/icon/security.svg',       label: 'Coffre-fort à la demande' },
    ],
    'chambre-deluxe': [
        ...
        { icon: '/assets/images/icon/balcony.svg',        label: 'Balcon ou non' },
        { icon: '/assets/images/icon/refrigerator.svg',   label: 'Mini bar' },
        { icon: '/assets/images/icon/security.svg',       label: 'Coffre-fort ' },
    ],
    'suite-junior': [
        { icon: '/assets/images/icon/bed.svg',            label: '1 Lit double et 2 chevets' },
        { icon: '/assets/images/icon/shower.svg',         label: 'Baignoire' },
        { icon: '/assets/images/icon/desk.svg',           label: 'Table de travail' },
        { icon: '/assets/images/icon/hot-coffe.svg',      label: 'Plateau de courtoisie' },
        { icon: '/assets/images/icon/snow.svg',           label: 'Climatisation' },
        { icon: '/assets/images/icon/wifi.svg',           label: 'Wifi' },
        { icon: '/assets/images/icon/balcony.svg',        label: 'Balcon ou non' },
        { icon: '/assets/images/icon/refrigerator.svg',   label: 'Mini bar' },
        { icon: '/assets/images/icon/home-theater.svg',   label: '2 Télévisions écran plat' },
    ],
    'suite-senior': [
        { icon: '/assets/images/icon/bed.svg',            label: '1 Lit double et 2 chevets' },
        { icon: '/assets/images/icon/shower.svg',         label: 'Baignoire' },
...
export default function RoomDetailsClient({ roomPost }) {
    ...
    const amenities  = amenitiesParChambre[roomPost.slug]  || [];
